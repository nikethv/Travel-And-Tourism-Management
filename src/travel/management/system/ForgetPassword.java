...
public class ForgetPassword extends JFrame implements ActionListener{
    ...
    ForgetPassword(){
        ...
        lblusername.setFont(new Font("Fahoma",Font.BOLD,14));
        p1.add(lblusername);
        ...
        lblname.setFont(new Font("Fahoma",Font.BOLD,14));
        p1.add(lblname);
        ...
        lblquestion.setFont(new Font("Fahoma",Font.BOLD,14));
        p1.add(lblquestion);
        ...
        lblanswer.setFont(new Font("Fahoma",Font.BOLD,14));
        p1.add(lblanswer);
        ...
        lblpassword.setFont(new Font("Fahoma",Font.BOLD,14));
        p1.add(lblpassword);
